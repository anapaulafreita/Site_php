                                        ...
                                        ?>
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                    ...
                                                    <a a href="apaga_cliente.php?id=<?php echo $dados['id_cliente']; ?>" class="btn btn-danger" ><button onclick="myFunction()">Apagar</button></a>                                                    
                                                </div>
                                            </td>
                                        <?php
                                            echo "</tr>";
...
<script>
function myFunction() {
  alert("Olá!\nVocê realmente deseja apagar este usuário?");
}
</script>
                                    </tbody>                                    
                                </table>
